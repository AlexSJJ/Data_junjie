...
def get_user_input():
    ...
    try:
        customers = open(".\data\customers1.csv", 'r').readlines()
...
#
# pro_name_fraud = 'fraud_' + pro_name
# print(pro_name_fraud)
## python datagen_transaction_new.py ".\data\customers.csv" ".\profiles\adults_2550_female_rural.json" 1-1-2012 1-31-2012 >> ".\data\adults_2550_female_rural.csv"
...
# line = "535-89-6775|346545733014127|Christopher|Sheppard|M|013 Daniel Trafficway Suite 429|Tomah|WI|54660|43.9838|-90.4733|15688|Psychologist, occupational|1993-02-10|639356225004|adults_2550_male_urban.json"
# cols = [c.replace('\n', '') for c in line.split('|')]
# headers = ['ssn', 'cc_num', 'first', 'last', 'gender', 'street',
#            'city', 'state', 'zip', 'lat', 'long', 'city_pop',
#            'job', 'dob', 'acct_num', 'profile', 'trans_num', 'trans_date', 'trans_time', 'unix_time', 'category', 'amt',
...
# ".\data\customers.csv" ".\profiles\adults_2550_female_rural.json" 1-1-2012 12-31-2013 >> ".\data\adults_2550_female_rural.csv"
